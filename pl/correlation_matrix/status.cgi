...
$result = `ssh -i /home/yonggan/.ssh/id_rsa_nick act\@10.1.10.25 'ls /home/act/software/nickbild/webdata/correlation_matrix/$unique/correlation/run.finished'`;
...
if ($result eq "") {
	...
	$var = `scp -i /home/yonggan/.ssh/id_rsa_nick act\@10.1.10.25:/home/act/software/nickbild/webdata/correlation_matrix/$unique/correlation/* ./$unique/`;
